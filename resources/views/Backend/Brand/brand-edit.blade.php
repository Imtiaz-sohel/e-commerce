        ...
        <div class="row justify-content-center">
            <div class="col-xl-6">
                <div class="form-layout form-layout-5 bg-white">
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 text-center">Edit BRAND</h6>
                    <form action="{{ route('brand.update',$brandEdit->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                              <input type="text" name="brand_name" id="brand_name" value="{{ $brandEdit->brand_name ?? old('brand_name') }}" class="form-control @error('brand_name') is-invalid @enderror" placeholder="Enter bradname">
                              @error('brand_name')
